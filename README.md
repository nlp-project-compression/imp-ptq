...
IMP–PTQ is a research codebase for comparing Iterative Magnitude Pruning (IMP) and Post-Training Quantization (PTQ) on GLUE tasks using BERT-style models. It provides reproducible pipelines for pruning, quantization, calibration ablations, and evaluation.
